...
上图是 Apache Rocketmq 社区和 Apache Dubbo 社区放置到 GSoC 上的选题，今年这两个社区中选的人数都是2人。所以即使落选了也不必患得患失。如果有幸中选，那恭喜你已经获得了社区和组织的认可！GSoC 的评选逻辑是，在导师分别对每个题目下所有人的提案排序之后，谷歌会给到组织/社区一个具体名额，所有题目还要经过组织的再排序，如果你的题目的排名最后在google给定名额以内，那就意味着你中选了。但即使最后题目没能被 GSoC 官方选中，如果你的提案被导师认可，仍然可以去完成这个工作，不过就没有 GSOC 的奖金可以拿了。
